...
public class BookService {
    ...
    public ResponseDto<List<BookResponseDto>> getBooksByCategory(C_Category category) {
        ...
        try{
            ...
            return ResponseDto.setSuccess("카테고리별 책 조회가 성공했습니다.", books);
        }catch (Exception e){
            e.printStackTrace();
            return ResponseDto.setFailed("카테고리별 책을 검색하는 동안 문제가 발생했습니다.");
        }
    }
    ...
    public ResponseDto<List<BookResponseDto>> getBooksByCategoryAndWriter(C_Category category, String writer) {
        ...
        try{
            ...
            e.printStackTrace();
            return ResponseDto.setFailed("카테고리와 작성자로 조회하는 동안 문제가 발생했습니다");
        }
    }
}
